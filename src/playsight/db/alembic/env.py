"""Alembic environment wired to playsight settings and Base.metadata.

No migrations are committed yet (Phase 1 uses ``init_db()`` for local/dev);
this scaffold makes ``alembic revision --autogenerate`` work out of the box.
"""
...
def _database_url() -> str:
    """Resolve the database URL from playsight settings (env-aware)."""
